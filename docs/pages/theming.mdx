...
By default all Vechai components use the default theme. You can extend and customize theme on top level with MintflowProvider.

## MintflowProvider

MintflowProvider component allows you to change theme globally. It is not required if you decide to stick with default theme:

```jsx
import * as React from "react";

// 1. import `MintflowProvider` component
import { MintflowProvider, Button } from "@mintgate/mintflow/react";
...
import { extendTheme, colors } from "@mintgate/mintflow/react";
...
// 4. Pass the new theme to `MintflowProvider`
<MintflowProvider theme={theme} colorScheme="cool">
  <App />
</MintflowProvider>
...
```jsx
<MintflowProvider density="compact">
  <App />
</MintflowProvider>
```
...
@mintgate/mintflow/react package exports types:
